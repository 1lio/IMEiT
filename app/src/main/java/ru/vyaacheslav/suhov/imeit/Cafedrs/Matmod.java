...
public class Matmod extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ab_ch = v.findViewById(R.id.ab_matmod);

            tel = v.findViewById(R.id.tel_m);
            mail = v.findViewById(R.id.emal_m);
            address =v.findViewById(R.id.map_m);
        ...
        ab_ch.setOnClickListener(new View.OnClickListener() {
            ...
            tel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:+74746728172"));
            ...
            mail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    email.putExtra(Intent.EXTRA_EMAIL, new String[]{"kmaiem12@mail.ru"});
