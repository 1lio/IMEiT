...
public class Informat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.caf_mat_inf, container, false);
        ab_ch = v.findViewById(R.id.ab_tex);

        tel = v.findViewById(R.id.tel_mi);
        mail = v.findViewById(R.id.emal_mi);
        address =v.findViewById(R.id.map_mi);
        ...
        tel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:++74746720001"));
        ...
        mail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                email.putExtra(Intent.EXTRA_EMAIL, new String[]{"podaeva@mail.ru"});
