...
import ru.suhov.student.viewmodel.AuthSignInModel
import ru.suhov.student.R
import ru.suhov.student.util.isValidEmail
import ru.suhov.student.util.isValidPass
...
class SignInFragment : BaseAuthFragment() {
    ...
    override fun onViewCreated(view: View, instance: Bundle?) {
        ...
        authRestore.setOnClickListener {
            ...
            fm.beginTransaction().replace(R.id.frameLayout, AuthRestoreFragment(fm)).commit()
        }
