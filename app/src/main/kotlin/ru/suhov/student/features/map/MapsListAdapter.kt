...
import ru.student.core.entity.PointLocation
...
class MapsListAdapter : BaseAdapter<PointLocation, MapsListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_maps, parent, false))


    inner class ViewHolder(itemView: View) : BaseViewHolder<PointLocation>(itemView) {
        ...
        override fun bind(item: PointLocation) {
            name.text = item.name
